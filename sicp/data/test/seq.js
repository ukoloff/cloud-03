...
console.log("[1, 2, 3, 1, 2] =", seq.append(s3, s2))
console.log("[1, 2, 1, 2, 3] =", seq.append(s2, s3))
console.log("[1, 2] =", seq.append(s2, s0))
console.log("[1, 2] =", seq.append(s0, s2))
